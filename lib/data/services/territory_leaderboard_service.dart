...
class TerritoryLeaderboardService {
  ...
  Future<List<Territory>> getAllTerritories() async {
    try {
      ...
      AppLogger.error(LogLabel.supabase, "Error fetching territories: $e");
      rethrow;
    }
  }
  ...
  Future<List<Territory>> searchTerritories(String query) async {
    try {
      ...
      AppLogger.error(LogLabel.supabase, "Error searching territories: $e");
      rethrow;
    }
  }
    ...
    try {
      ...
      for (final run in limitedRuns) {
        ...
        try {
          ...
          AppLogger.error(LogLabel.supabase, "Error fetching user for run ${run['id']}: $e");
      ...
      AppLogger.error(LogLabel.supabase, "Error fetching territory leaderboard: $e");
      rethrow;
    }
  }
  ...
  Future<RunSession?> getUserBestRunForTerritory({
    ...
    try {
      ...
      try {
        ...
        AppLogger.error(LogLabel.supabase, "Error fetching user data: $e");
        // Continue without user data
      }

      return RunSession.fromJson(runData);
    } catch (e) {
      AppLogger.error(LogLabel.supabase, "Error fetching user best run: $e");
      rethrow;
    }
  }
  ...
  Future<List<RunSession>> getUserRunsInTerritory({
    ...
    try {
      ...
      AppLogger.error(LogLabel.supabase, "Error fetching user runs in territory: $e");
      rethrow;
    }
  }
  ...
  Future<TerritoryStats?> getTerritoryStats(int territoryId) async {
    try {
      ...
      AppLogger.error(LogLabel.supabase, "Error fetching territory stats: $e");
      return null;
    }
  }
  ...
  Future<List<Territory>> getUserOwnedTerritories(String userId) async {
    try {
      ...
      AppLogger.error(LogLabel.supabase, "Error fetching user territories: $e");
      rethrow;
    }
  }
  ...
  Future<List<Territory>> getTerritoriesByDifficulty(String difficulty) async {
    try {
      ...
      AppLogger.error(LogLabel.supabase, "Error fetching territories by difficulty: $e");
      rethrow;
    }
  }
}
